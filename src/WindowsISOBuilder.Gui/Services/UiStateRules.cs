...
public static class UiStateRules
{
    public static bool CanTransition(UiState from, UiState to)
    {
        ...
        return from switch
        {
            ...
            UiState.ReadyToBuild => to is UiState.Building or UiState.Preflighting or UiState.LoadingBuild or UiState.LoadingLanguages or UiState.LoadingEditions or UiState.Failed,
            UiState.Building => to is UiState.Cancelling or UiState.Completed or UiState.Cancelled or UiState.Failed,
            UiState.Cancelling => to is UiState.Cancelled or UiState.Completed or UiState.Failed,
            UiState.Completed or UiState.Failed or UiState.Cancelled => to is UiState.Idle or UiState.ReadyToPreflight or UiState.LoadingBuild or UiState.Failed,
            _ => false
        };
    }
}
