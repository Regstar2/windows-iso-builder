...
internal static class ErrorMapper
{
    public static ErrorMapping Map(string? code) => code switch
    {
        ...
        "PROXY_CONFIGURATION_INVALID" => new("ErrorProxyConfigurationTitle", "ErrorProxyConfigurationAction"),
        "PROXY_CREDENTIAL_UNAVAILABLE" => new("ErrorProxyCredentialTitle", "ErrorProxyCredentialAction"),
        "PROXY_CONNECTION_FAILED" => new("ErrorProxyConnectionTitle", "ErrorProxyConnectionAction"),
        "PROXY_AUTHENTICATION_FAILED" => new("ErrorProxyAuthenticationTitle", "ErrorProxyAuthenticationAction"),
